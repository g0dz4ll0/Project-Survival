...
{
    [Header("Configurações da Billboard da Relva")]
    ...
    [Header("Configuração da Mesh de Detalhes")]
    ...
    [Range(0, 1)] public float HoleEdgePadding = 0f;
...
public class BaseDetailPainter : MonoBehaviour
{
    ...
    {
        Debug.LogError("Nenhuma implementação da função de execução para " + gameObject.name);
    }
